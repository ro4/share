<div class="navbar navbar-static-top navbar-inverse">
        	<div class="navbar-inner">
            	<div style="padding:0 30px;">
                	<a href="/" class="brand" style="margin-right:20px;">SHARE后台管理</a>
...
<div class="row" >
	...
	<div class="sidebar-menu">
		<a href="#questionMenu" class="nav-header menu-first collapsed" data-toggle="collapse"><i class="icon-book icon-large"></i> 资料管理</a>
		<ul id="questionMenu" class="nav nav-list collapse menu-second">
			<li><a href="<?php echo $this->createUrl('question/index');?>" target="main"><i class="icon-list-alt"></i> 资料列表</a></li>
		</ul>
